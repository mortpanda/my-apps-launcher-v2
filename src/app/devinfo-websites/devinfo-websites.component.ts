...
import { Websites, DevInfo } from '../shared/websites/websites';

@Component({
  selector: 'app-devinfo-websites',
  templateUrl: './devinfo-websites.component.html',
  styleUrls: ['./devinfo-websites.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DevinfoWebsitesComponent implements OnInit {
  DevInfo=DevInfo;
  smallScreen: boolean;

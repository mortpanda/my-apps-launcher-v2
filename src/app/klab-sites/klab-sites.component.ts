...
import { Websites, KlabSites } from '../shared/websites/websites';


@Component({
  selector: 'app-klab-sites',
  templateUrl: './klab-sites.component.html',
  styleUrls: ['./klab-sites.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class KlabSitesComponent implements OnInit {
  smallScreen: boolean;

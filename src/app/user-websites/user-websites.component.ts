...
import { Websites, UserSites } from '../shared/websites/websites';

@Component({
  selector: 'app-user-websites',
  templateUrl: './user-websites.component.html',
  styleUrls: ['./user-websites.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class UserWebsitesComponent implements OnInit {
  UserSites=UserSites;
  smallScreen: boolean;
